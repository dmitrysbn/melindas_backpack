...
class BackpackTest < MiniTest::Test
  ...
  def test_that_backpack_has_gym_shoes_on_mon_and_thu
  ...
  def test_that_backpack_has_no_gym_shoes_on_other_days
...
- gym shoes
- packed lunch"
    assert_equal(expected, backpack.summary_of_items)
  end
